...
/**
 * VolumenPruebaController implements the CRUD actions for VolumenPrueba model.
 */
class VolumenPruebaController extends ActiveController
{
    public $modelClass = 'app\models\VolumenPrueba';
