...
/**
 * TipoDomicilioController implements the CRUD actions for TipoDomicilio model.
 */
class TipoDomicilioController extends ActiveController
{

    public $modelClass = 'app\models\TipoDomicilio'; 
