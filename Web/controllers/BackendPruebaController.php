...
/**
 * BackendPruebaController implements the CRUD actions for Prueba model.
 */
class BackendPruebaController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->idprueba]);
        }
