...
/**
 * BackendDomicilioController implements the CRUD actions for Domicilio model.
 */
class BackendDomicilioController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->iddomicilio]);
        }
