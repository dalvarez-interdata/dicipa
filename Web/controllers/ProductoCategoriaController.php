...
/**
 * ProductoCategoriaController implements the CRUD actions for ProductoCategoria model.
 */
class ProductoCategoriaController extends ActiveController
{
    public $modelClass = 'app\models\ProductoCategoria';     
