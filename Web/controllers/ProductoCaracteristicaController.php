...
/**
 * ProductoCaracteristicaController implements the CRUD actions for ProductoCaracteristica model.
 */
class ProductoCaracteristicaController extends ActiveController
{
    public $modelClass = 'app\models\ProductoCaracteristica';
