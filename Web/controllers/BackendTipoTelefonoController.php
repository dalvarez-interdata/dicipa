...
use app\models\TipoTelefonoSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * BackendTipoTelefonoController implements the CRUD actions for TipoTelefono model.
 */
class BackendTipoTelefonoController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->idtipo_telefono]);
        }
