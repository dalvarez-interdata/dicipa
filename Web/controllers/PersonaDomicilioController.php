...
/**
 * PersonaDomicilioController implements the CRUD actions for PersonaDomicilio model.
 */
class PersonaDomicilioController extends ActiveController
{

    public $modelClass = 'app\models\PersonaDomicilio'; 
