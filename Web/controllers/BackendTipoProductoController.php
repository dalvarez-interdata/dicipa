...
/**
 * BackendTipoProductoController implements the CRUD actions for TipoProducto model.
 */
class BackendTipoProductoController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->idTipoProducto]);
        }
