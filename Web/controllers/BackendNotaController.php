...
/**
 * BackendNotaController implements the CRUD actions for Nota model.
 */
class BackendNotaController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->idnotas]);
        }
