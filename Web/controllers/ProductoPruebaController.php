...
/**
 * ProductoPruebaController implements the CRUD actions for ProductoPrueba model.
 */
class ProductoPruebaController extends ActiveController
{
    public $modelClass = 'app\models\ProductoPrueba';  
