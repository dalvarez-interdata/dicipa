...
$this->title = Yii::t('app', 'type_homes');
    ...
    <div class="col-md-7 col-4 align-self-center">
        <div class="d-flex m-t-10 justify-content-end">
            <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                <?= Html::a(Yii::t('app', Yii::t ('app', 'new_type_home') ), ['create'], ['class' => 'btn btn-success']) ?>
            </div>
        </div>
    </div>      
</div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="usuario-index">
                   ...
                   <h3 class="card-title"><?php echo Yii::t ('app', 'list_type_homes')?></h3>
                    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
                        ...
                        <?= GridView::widget([
                            'summary' => '<div class="row">
                                    ...
                                    <div class="col-7">
                                        <div class="table-summary">Total {totalCount} '.Yii::t ('app', 'type_homes_plural').'</div>
                                    </div>
                                </div>',
                            'showHeader' => true,
